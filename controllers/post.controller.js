...
export const getPostToId = expressAsyncHandler(async (req, res) => {
  ...
  try {
    ...
    if (post[0]) {
      ...
      const { id: idDB, userid: useridDB, username: usernameDB, avatar: avatarDB,  description: descriptionDB, image: imageDB, created_at: created_atDB, likes: likesDB, category: categoryDB } = post[0];
